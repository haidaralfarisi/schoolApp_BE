                                    ...
                                    @else
                                        @foreach ($ereports as $ereport)
                                            ...
                                            <div class="modal fade" id="editStudentModal{{ $ereport->id }}" tabindex="-1"
                                                aria-labelledby="editStudentModalLabel{{ $ereport->id }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="editStudentModalLabel{{ $ereport->id }}">
                                                                Edit Data E-report
                                                            </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('students.update', $ereport->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        name="fullname" value="{{ $ereport->fullname }}"
                                                                        required>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label class="form-label">Username</label>
                                                                    <input type="text" class="form-control"
                                                                        name="username" value="{{ $ereport->username }}"
                                                                        required>
                                                                </div>
                                                                <div class="mb-3">

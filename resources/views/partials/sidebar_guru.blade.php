    ...
    <div class="p-3">
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                <!-- Schools -->
                {{-- <li class="sidebar-item">
                    <a class="sidebar-link" href="{{ route('guru.schools.index') }}" aria-expanded="false">
                        <span>
                ...
                <!-- Users -->
                {{-- <li class="sidebar-item">
                    <a class="sidebar-link" href="{{ route('guru.users.index') }}" aria-expanded="false">
                        <span>
                ...
                <!-- E-Raport -->
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{ route('guru.eraports.index') }}" aria-expanded="false">
                        <span>
                ...
                <!-- Student Notes -->
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{ route('guru.notes.index') }}" aria-expanded="false">
                        <span>
                            <iconify-icon icon="solar:user-plus-rounded-bold-duotone" class="fs-6"></iconify-icon>
                        </span>

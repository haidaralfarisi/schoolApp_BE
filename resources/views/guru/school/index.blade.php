                                    ...
                                    @else
                                        @foreach ($schools as $school)
                                            ...
                                            <div class="modal fade" id="editStudentModal{{ $school->id }}" tabindex="-1"
                                                aria-labelledby="editStudentModalLabel{{ $school->id }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="editStudentModalLabel{{ $school->id }}">
                                                                Edit Data Siswa
                                                            </h5>
                                                            ...
                                                            <form action="{{ route('students.update', $student->id) }}"
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        name="fullname" value="{{ $school->fullname }}"
                                                                        required>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label class="form-label">Username</label>
                                                                    <input type="text" class="form-control"
                                                                        name="username" value="{{ $school->username }}"
                                                                        required>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label class="form-label">Tahun Masuk</label>
                                                                    <input type="number" class="form-control"
                                                                        name="entry_year" value="{{ $school->entry_year }}"
                                                                        required>
                                                                </div>

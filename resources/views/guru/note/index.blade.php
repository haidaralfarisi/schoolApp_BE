                            ...
                            <tr>
                                <td colspan="10" class="text-center">
                                    <div class="py-4">
                                        ...
                                        <p class="mt-2 text-muted">Tidak ada data Student Notes</p>
                                    </div>
                                </td>
                            </tr>
                        @else
                            @foreach ($notes as $note)
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                        data-bs-target="#editStudentModal{{ $note->id }}">
                                ...
                                <!-- Modal Edit -->
                                <div class="modal fade" id="editStudentModal{{ $note->id }}" tabindex="-1"
                                    aria-labelledby="editStudentModalLabel{{ $note->id }}" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editStudentModalLabel{{ $note->id }}">
                                                    Edit Data E-report
                                                </h5>
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('students.update', $note->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="fullname"
                                                            value="{{ $note->fullname }}" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Username</label>
                                                        <input type="text" class="form-control" name="username"
                                                            value="{{ $note->username }}" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Tahun Masuk</label>
                                                        <input type="number" class="form-control" name="entry_year"
                                                            value="{{ $note->entry_year }}" required>
                                                    </div>
